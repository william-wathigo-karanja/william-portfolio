...
export default function Hero() {
  return (
    <>
          ...
          <Row className="align-items-center justify-content-center flex-column-reverse flex-md-row">
            ...
            >
              ...
              >
                ...
                >
                  Passionate about building modern, efficient, and user-friendly
                  web and mobile applications. Dedicated to clean code, creative
                  design, and crafting solutions that make a real impact.
                </p>
      ...
      {/* Smooth Wave Transition to About Section */}
      <SectionDivider />
    </>
  );
}
